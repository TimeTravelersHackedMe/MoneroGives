...
function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module["wasmTextFile"] || "zeriam.wast";
    var wasmBinaryFile = Module["wasmBinaryFile"] || "zeriam.wasm";
    var asmjsCodeFile = Module["asmjsCodeFile"] || "zeriam.temp.asm.js";
...
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "zeriam.js.mem" : null;
